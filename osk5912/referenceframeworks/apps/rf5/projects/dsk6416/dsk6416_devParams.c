...
/*
 *  ======== dsk6416_devParams.c ========
 *  DSK6416_EDMA_AIC23 default driver parameters
 */
#include <std.h>
 ...
 */
DSK6416_EDMA_AIC23_DevParams DSK6416_DEVPARAMS = {
    DSK6416_EDMA_AIC23_VERSION_1, /* Drivers version used by app */     \
    ...
    FALSE,                        /* Rx/TX buffer on the receiving */   \
                                  ...
                                  /* in driver                     */
    DSK6416_EDMA_AIC23_IRQID_DEFAULT, /* Default IRQ # for EDMA is 8 */ \
    AIC23_REG0_DEFAULT,                                                 \
    AIC23_REG1_DEFAULT,                                                 \
    AIC23_REG2_DEFAULT,                                                 \
    AIC23_REG3_DEFAULT,                                                 \
    ...
    AIC23_9BITWORD(              /* REG 8: sample rate */
        ...
        /* USB/N  */  1          /* clock mode select (USB/normal): USB */
                                                                        ...
                                                                        \
    AIC23_REG9_DEFAULT,                                                 \
    DSK6416_EDMA_AIC23_INTR_MASK_DEFAULT, /* Interrupt mask = 1 */      \
