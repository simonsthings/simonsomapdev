...
MEMORY {
   ...
   PRGDUMMY:   origin = 0x1000000,     len = 0x2
   DARAMOVL:   origin = 0xe000,        len = 0x2000
}
/* MODULE CLK */
SECTIONS {
   .clk: block(0x20000){
...
SECTIONS {
        ...
        /* pipTx buffer */
        .pip1: block(0x20000) align = 0x4 {} > DARAM
        ...
        /* LOG_system buffer */
        .LOG_system$buf: block(0x20000) align = 0x40 fill = 0xffff {} > DARAM
