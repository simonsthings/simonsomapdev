...
SECTIONS {
        ...
        /* pipTx buffer */
        .pip5: block(0x20000) align = 0x4 {} > DARAM
        ...
        /* pipTx1 buffer */
        .pip4: block(0x20000){} > DARAM
        
        .cio:     {} > DARAM
        
        /* pipRx1 buffer */
        .pip3: block(0x20000){} > DARAM
        
        /* pipTx0 buffer */
        .pip2: block(0x20000){} > DARAM
        
        /* pipRx0 buffer */
        .pip1: block(0x20000){} > DARAM
        ...
        /* pipRx buffer */
        .pip0: block(0x20000) align = 0x4 {} > DARAM
       ...
       .hst0: block(0x20000) align = 0x4 {} > DARAM
        ...
        /* logTrace buffer */
        .logTrace$buf: block(0x20000) align = 0x100 fill = 0xffff {} > DARAM
        
        /* LOG_system buffer */
        .LOG_system$buf: block(0x20000) align = 0x100 fill = 0xffff {} > DARAM
        ...
        .pinit: block(0x20000)    {} > SARAM_A
        
        .cinit: block(0x20000)    {} > SARAM_A
        
        .switch:    {} > SARAM_A
        
        .trcdata:    {} > SARAM_A
        
        .gblinit: block(0x20000)   {} > SARAM_A
        
        .SDRAM$heap: {
            SDRAM$B = .;
            _SDRAM_base = .;
            SDRAM$L = 0x4000;
            _SDRAM_length = 0x4000;
            . += 0x4000;
        } > SDRAM
