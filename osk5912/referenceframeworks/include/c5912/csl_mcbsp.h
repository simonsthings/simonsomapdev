...
#define CSL_MCBSP_HWSETUP_DEFAULTS {                \
    CSL_MCBSP_GLOBALSETUP_DEFAULTS,                 \
    CSL_MCBSP_DATASETUP_DEFAULTS,                   \
    CSL_MCBSP_DATASETUP_DEFAULTS,                   \
    CSL_MCBSP_CLOCKSETUP_DEFAULTS,                  \
    CSL_MCBSP_MULTICHAN_DEFAULTS,                   \
    CSL_MCBSP_EMUMODE_DEFAULT,                      \
    CSL_MCBSP_EXTENDSETUP_DEFAULT                   \
  }
/**
@} */
 ...
 * and returns to ORed status of them in the 3rd argument of
 * @a CSL_mcbspGetHwStatus()
 *
 * @param  (Uint16 *)
 * @return CSL_SOK
 */
