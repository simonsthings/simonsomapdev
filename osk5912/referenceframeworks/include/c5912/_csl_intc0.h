...
/*-------------------------------------------------------------------------------*/
inline CSL_Intc0GlobalEnableState _CSL_intc0GlobalDisable(
        void
)
{
    CSL_Intc0GlobalEnableState    prevState;

    prevState = (CSL_Intc0GlobalEnableState)CSL_FEXT(CSL_sysDataHandle->chipRegs->ST1_55, CHIP_ST1_55_INTM);
    asm(" BSET INTM");
...
/*-------------------------------------------------------------------------------*/
inline CSL_Intc0GlobalEnableState _CSL_intc0GlobalEnable(
        void
)
{
    CSL_Intc0GlobalEnableState    prevState;
...
/*-------------------------------------------------------------------------------*/
inline void _CSL_intc0GlobalRestore(
        CSL_Intc0GlobalEnableState  prevState
)
{
...
/*-------------------------------------------------------------------------------*/
inline void _CSL_intc0Clear (
        CSL_Intc0EventId    evtId
)
{
    if ( evtId <= _CSL_INTC_EVENTID__IVPDEND)  {
...
/*-------------------------------------------------------------------------------*/
inline CSL_Intc0EventEnableState _CSL_intc0Disable (
        CSL_Intc0EventId    evtId
)
{
...
/*-------------------------------------------------------------------------------*/
inline CSL_Intc0EventEnableState _CSL_intc0Enable (
        CSL_Intc0EventId    evtId
)
{
    CSL_Intc0EventEnableState   en;
...
/*-------------------------------------------------------------------------------*/
inline CSL_Status _CSL_intc0Restore (
        CSL_Intc0EventId        evtId,
...
)
{
    if (evtId <= _CSL_INTC_EVENTID__IVPDEND) {
        ...
        CSL_FINSR(CSL_sysDataHandle->chipRegs->IER1, evtId, evtId, prevState);
    }
    return CSL_SOK;
}
/*-------------------------------------------------------------------------------*/
