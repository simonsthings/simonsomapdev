...
\**************************************************************************/
typedef enum  {
   CSL_CHIP_IER0 = 0x0000u,
   CSL_CHIP_IFR0 = 0x0001u,
   CSL_CHIP_ST0_55 = 0x0002u,
   CSL_CHIP_ST1_55 = 0x0003u,
   CSL_CHIP_ST3_55 = 0x0004u,
   CSL_CHIP_PDP = 0x002Fu,
   CSL_CHIP_IER1 = 0x0045u,
   CSL_CHIP_IFR1 = 0x0046u,
   CSL_CHIP_DBIER0 = 0x0047u,
   CSL_CHIP_DBIER1 = 0x0048u,
   CSL_CHIP_IVPD = 0x0049u,
   CSL_CHIP_IVPH = 0x004Au,
   CSL_CHIP_ST2_55 = 0x004Bu
} CSL_ChipRegIds;
/**************************************************************************\
