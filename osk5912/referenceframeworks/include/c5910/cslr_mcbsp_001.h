...
\**************************************************************************/
typedef enum  {
   CSL_MCBSP_DRR2 = 0x0000u,
   CSL_MCBSP_DRR1 = 0x0001u,
   CSL_MCBSP_DXR2 = 0x0002u,
   CSL_MCBSP_DXR1 = 0x0003u,
   CSL_MCBSP_SPCR2 = 0x0004u,
   CSL_MCBSP_SPCR1 = 0x0005u,
   CSL_MCBSP_RCR2 = 0x0006u,
   CSL_MCBSP_RCR1 = 0x0007u,
   CSL_MCBSP_XCR2 = 0x0008u,
   CSL_MCBSP_XCR1 = 0x0009u,
   CSL_MCBSP_SRGR2 = 0x000Au,
   CSL_MCBSP_SRGR1 = 0x000Bu,
   CSL_MCBSP_MCR2 = 0x000Cu,
   CSL_MCBSP_MCR1 = 0x000Du,
   CSL_MCBSP_RCERA = 0x000Eu,
   CSL_MCBSP_RCERB = 0x000Fu,
   CSL_MCBSP_XCERA = 0x0010u,
   CSL_MCBSP_XCERB = 0x0011u,
   CSL_MCBSP_PCR = 0x0012u,
   CSL_MCBSP_RCERC = 0x0013u,
   CSL_MCBSP_RCERD = 0x0014u,
   CSL_MCBSP_XCERC = 0x0015u,
   CSL_MCBSP_XCERD = 0x0016u,
   CSL_MCBSP_RCERE = 0x0017u,
   CSL_MCBSP_RCERF = 0x0018u,
   CSL_MCBSP_XCERE = 0x0019u,
   CSL_MCBSP_XCERF = 0x001Au,
   CSL_MCBSP_RCERG = 0x001Bu,
   CSL_MCBSP_RCERH = 0x001Cu,
   CSL_MCBSP_XCERG = 0x001Du,
   CSL_MCBSP_XCERH = 0x001Eu
} CSL_McbspRegIds;
/**************************************************************************\
...
#define CSL_MCBSP_SPCR1_ABIS_MASK     (0x0040u)
#define CSL_MCBSP_SPCR1_ABIS_SHIFT    (0x0006u)
#define CSL_MCBSP_SPCR1_ABIS_RESETVAL (0x0000u)
