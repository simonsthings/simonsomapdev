TITLE
-----
INNOV5910_DMA_AIC23_CSLV3 (IOM driver for INNOVATOR5910/AIC23 codec)

THIS DRIVER USES CHIP SUPPRT LIBRARY (CSL) V3.X

USAGE
-----
This device driver is a mini-driver for the codec on the Innovator 5910 
and uses the generic C5910_DMA_MCBSP driver to transfer data to and from the 
serial ports. Because this driver is dependent on the generic C5910_DMA_MCBSP 
...
are called innov5910_dma_aic23_cslv3.l55l and c5910_dma_mcbsp_cslv3.l55l which
are located in referenceframework/lib directory.

DESCRIPTION
-----------
INNOVATOR5910AIC23 is an IOM driver for the INNOVATOR 5910.  This board has 
an AIC23 stereo codec on it. The driver is implemented using DMA. 

FILES
-----
- innov5910_dma_aic23_cslv3.pjt: project file for building the driver library 
	for large model on the innovator5910 platform. 

- innov5910_dma_aic23_cslv3.c: initialization of McBSP and DMA 

- referenceframework/include/innov5910_dma_aic23_cslv3.h: 
...
A2: There are two ways to change DMA channels:
    ...
    1) Static way:
	   ...
	   INNOV5910_DMA_AIC23_CSLV3_DevParams myParams = {
