 ...
 *
 *  @desc   Defines the interface of PROC_Load API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (API_PROCLOAD_H)
#define API_PROCLOAD_H
 ...
 *  @func   API_ProcLoad
 *
 *  @desc   Entry point for the PROC_Load  API Test.
 *
 *  @arg    argc
