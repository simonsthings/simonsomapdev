/** ============================================================================
 *  @file   API_MsgqCreate.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Defines the interface of MSGQ_Create API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (API_MSGQCREATE_H)
#define API_MSGQCREATE_H
 ...
 *  @func   API_MsgqCreate
 *
 *  @desc   Entry point for the MSGQ_Create  API.
 *
 *  @arg    argc
...
#endif /* !defined (API_MSGQCREATE_H) */
