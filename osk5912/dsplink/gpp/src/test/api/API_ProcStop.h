 ...
 *
 *  @desc   Defines the interface of PROC_Stop API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (API_PROCSTOP_H)
#define API_PROCSTOP_H
 ...
 *  @func   API_ProcStop
 *
 *  @desc   Entry point for the PROC_Stop  API.
 *
 *  @arg    argc
