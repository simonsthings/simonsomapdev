/** ============================================================================
 *  @file   API_ChnlControl.c
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Implemetation of Chnl_Control API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
/** ============================================================================
 *  @func   API_ChnlControl
 *
 *  @desc   This test case tests the Chnl_Control  API.
 *
 *  @modif  None.
 *  ============================================================================
 */
EXPORT_API
DSP_STATUS
API_ChnlControl (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 9) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_ChnlControl. Status = [0x%x]",
                      status) ;
    }
    ...
    if (DSP_SUCCEEDED (status)) {
        ...
        dummyArg                = TST_StringToInt (argv [8]) ;
        ...
        if (DSP_SUCCEEDED (statusOfSetup)) {
            statusOfSetup = CHNL_Create
                                (processorId, channelId, &chnlAttr) ;
        }
    }
    ...
    if (DSP_SUCCEEDED (status)) {
        status = CHNL_Control (processorId, channelId, dummyCmd, &dummyArg) ;
    }
