/** ============================================================================
 *  @file   API_MsgqRelease.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Defines the interface of MSGQ_Release API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (API_MSGQRELEASE_H)
#define API_MSGQRELEASE_H
 ...
 *
 *  @desc   Entry point for the MSGQ_Release API.
 *
 *  @arg    argc
...
#endif /* !defined (API_MSGQRELEASE_H) */
