/** ============================================================================
 *  @file   API_MsgqAlloc.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Defines the interface of MSGQ_Alloc API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (API_MSGQALLOC_H)
#define API_MSGQALLOC_H
 ...
 *  @func   API_MsgqAlloc
 *
 *  @desc   Entry point for the MSGQ_Alloc API.
 *
 *  @arg    argc
