/** ============================================================================
 *  @file   API_ProcAttach.c
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Implemetation of PROC_Attach API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
 ...
 *  @func   API_ProcAttach
 *
 *  @desc   Tests the PROC_Attach API.
 *
 *  @modif  None
 *  ============================================================================
 */
EXPORT_API
DSP_STATUS
API_ProcAttach (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 3) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_ProcAttach. Status = [0x%x]",
                      status) ;
    }
