/** ============================================================================
 *  @file   API_ChnlAllocateBuffer.c
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Implemetation of Chnl_AllocateBuffer API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
 ...
 *
 *  @desc   This test case tests the Chnl_AllocateBuffer  API
 *
 *  @modif  None.
 *  ============================================================================
 */
...
API_ChnlAllocateBuffer (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 9) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_ChnlAllocateBuffer. "
                      "Status = [0x%x]", status) ;
    }
