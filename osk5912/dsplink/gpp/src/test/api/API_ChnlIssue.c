/** ============================================================================
 *  @file   API_ChnlIssue.c
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Implemetation of Chnl_Issue API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
 ...
 *  @func   API_ChnlIssue
 *
 *  @desc   This test case tests the Chnl_Issue  API
 *
 *  @modif  None.
 *  ============================================================================
 */
EXPORT_API
DSP_STATUS
API_ChnlIssue (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 14) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_ChnlIssue. Status = [0x%x]",
                      status) ;
    }
