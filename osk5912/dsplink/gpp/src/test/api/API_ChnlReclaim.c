/** ============================================================================
 *  @file   API_ChnlReclaim.c
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Implemetation of Chnl_Reclaim API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
/** ============================================================================
 *  @func   API_ChnlReclaim
 *
 *  @desc   This test case tests the Chnl_Reclaim  API
 *
 *  @modif  None.
 *  ============================================================================
 */
EXPORT_API
DSP_STATUS
API_ChnlReclaim (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 14) || (argv == NULL)) {
        status = DSP_EINVALIDARG ;
        TST_PrnError ("Incorrect usage of API_ChnlReclaim. Status = [0x%x]",
                      status) ;
    }
    ...
    if (DSP_SUCCEEDED (status)) {
        ...
        whichBuf                = TST_StringToInt (argv [12]) ;
        timeOut                 = TST_StringToInt (argv [13]) ;
        ...
        if (DSP_SUCCEEDED (statusOfSetup)) {
            ioReq.buffer = bufArray [whichBuf] ;
