/** ============================================================================
 *  @file   API_ChnlFlush.c
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Implemetation of Chnl_Flush API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
 ...
 *  @func   API_ChnlFlush
 *
 *  @desc   This test case tests the Chnl_Flush  API
 *
 *  @modif  None.
 *  ============================================================================
 */
...
API_ChnlFlush (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 13) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_ChnlFlush. Status = [0x%x]",
                      status) ;
    }
    ...
    if (DSP_SUCCEEDED (status)) {
        status = CHNL_Flush (processorId, channelId) ;
    }
