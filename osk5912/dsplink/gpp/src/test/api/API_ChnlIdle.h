 ...
 *
 *  @desc   Defines the interface of Chnl_Idle API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (API_CHNLIDLE_H)
#define API_CHNLIDLE_H
