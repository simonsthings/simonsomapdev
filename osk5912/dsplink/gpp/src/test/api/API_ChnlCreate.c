/** ============================================================================
 *  @file   API_ChnlCreate.c
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Implemetation of Chnl_Create API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
 ...
 *  @func   API_ChnlCreate
 *
 *  @desc   This test case tests the Chnl_Create  API
 *
 *  @modif  None.
 *  ============================================================================
 */
...
API_ChnlCreate (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 8) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_ChnlCreate. Status = [0x%x]",
                      status) ;
    }
