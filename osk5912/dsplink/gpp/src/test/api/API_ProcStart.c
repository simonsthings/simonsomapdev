/** ============================================================================
 *  @file   API_ProcStart.c
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Implemetation of PROC_Start API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
EXPORT_API
DSP_STATUS
API_ProcStart (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 6) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_ProcStart. Status = [0x%x]",
                      status) ;
    }
    ...
    if (DSP_SUCCEEDED (status)) {
        ...
        startAgain = TST_StringToInt (argv [5]) ;
