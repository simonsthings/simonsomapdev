/** ============================================================================
 *  @file   API_PostProcess.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\api
 *
 *  @desc   Defines the interface of API_PostProcess function.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (API_POSTPROCESS_H)
#define API_POSTPROCESS_H
...
EXPORT_API
DSP_STATUS
API_PostProcess (IN DSP_STATUS statusOfTest,
...
#endif /* !defined (API_POSTPROCESS_H) */
