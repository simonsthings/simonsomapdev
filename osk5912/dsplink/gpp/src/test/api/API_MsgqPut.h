 ...
 *
 *  @desc   Defines the interface of MSGQ_Put API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (API_MSGQPUT_H)
#define API_MSGQPUT_H
 ...
 *  @func   API_MsgqPut
 *
 *  @desc   Entry point for the MSGQ_Put API.
 *
 *  @arg    argc
