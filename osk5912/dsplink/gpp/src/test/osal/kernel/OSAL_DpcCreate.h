/** ============================================================================
 *  @file   OSAL_DpcCreate.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\osal\kernel
 *
 *  @desc   Defines the interface of DPC_Create API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (OSAL_DPCCREATE_H)
#define OSAL_DPCCREATE_H
...
#endif /* !defined (OSAL_DPCCREATE_H) */
