/** ============================================================================
 *  @file   OSAL_IsrInitialize.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\osal\kernel
 *
 *  @desc   Defines the interface of ISR_Initialize API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (OSAL_ISRINITIALIZE_H)
#define OSAL_ISRINITIALIZE_H
...
#endif /* !defined (OSAL_ISRINITIALIZE_H) */
