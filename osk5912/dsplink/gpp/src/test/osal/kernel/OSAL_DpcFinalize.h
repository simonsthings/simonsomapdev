/** ============================================================================
 *  @file   OSAL_DpcFinalize.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\osal\kernel
 *
 *  @desc   Defines the interface of DPC_Finalize API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (OSAL_DPCFINALIZE_H)
#define OSAL_DPCFINALIZE_H
...
#endif /* !defined (OSAL_DPCFINALIZE_H) */
