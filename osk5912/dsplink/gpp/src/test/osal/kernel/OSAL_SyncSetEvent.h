/** ============================================================================
 *  @file   SYNC_ResetEvent.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\osal\kernel
 *
 *  @desc   Defines the interface of SYNC_SetEvent API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (OSAL_SYNCSETEVENT_H)
#define OSAL_SYNCSETEVENT_H
...
#endif /* !defined (OSAL_SYNCSETEVENT_H) */
