/** ============================================================================
 *  @file   OSAL_DpcSchedule.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\osal\kernel
 *
 *  @desc   Defines the interface of DPC_Schedule API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (OSAL_DPCSCHEDULE_H)
#define OSAL_DPCSCHEDULE_H
...
#endif /* !defined (OSAL_DPCSCHEDULE_H) */
