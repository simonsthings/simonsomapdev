/** ============================================================================
 *  @file   OSAL_DpcDelete.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\osal\kernel
 *
 *  @desc   Defines the interface of DPC_Delete API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (OSAL_DPCDELETE_H)
#define OSAL_DPCDELETE_H
...
#endif /* !defined (OSAL_DPCDELETE_H) */
