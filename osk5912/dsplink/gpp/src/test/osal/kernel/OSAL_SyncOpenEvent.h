/** ============================================================================
 *  @file   OSAL_SyncOpenEvent.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\osal\kernel
 *
 *  @desc   Defines the interface of SYNC_OpenEvent API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (OSAL_SYNCOPENEVENT_H)
#define OSAL_SYNCOPENEVENT_H
...
#endif /* !defined (OSAL_SYNCOPENEVENT_H) */
