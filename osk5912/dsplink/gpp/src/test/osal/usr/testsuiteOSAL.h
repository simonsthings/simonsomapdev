/** ============================================================================
 *  @file   TestSuite_Osal.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\osal\usr
 *
 *  @desc   Defines the interface of TestSuite_Osal Function.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (TESTSUITEOSAL_H)
#define TESTSUITEOSAL_H
