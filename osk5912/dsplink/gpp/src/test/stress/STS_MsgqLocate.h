/** ============================================================================
 *  @file   STS_MsgqLocate.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\stress
 *
 *  @desc   Defines the interface of STS_MsgqLocate test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (STS_MSGQLOCATE_H)
#define STS_MSGQLOCATE_H
 ...
 *  @func   STS_MsgqLocate
 *
 *  @desc   Entry point for the STS_MsgqLocate  test.
 *
 *  @arg    argc
...
#endif /* !defined (STS_MSGQLOCATE_H) */
