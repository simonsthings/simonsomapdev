/** ============================================================================
 *  @file   STS_MsgqMemoryLeakAllocator.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\stress
 *
 *  @desc   Defines the interface of STS_MsgqMemoryLeakAllocator test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (STS_MSGQMEMORYLEAKALLOCATOR_H)
#define STS_MSGQMEMORYLEAKALLOCATOR_H
...
#endif /* !defined (STS_MSGQMEMORYLEAKALLOCATOR_H) */
