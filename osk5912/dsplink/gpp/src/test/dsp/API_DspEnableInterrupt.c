/** ============================================================================
 *  @file   API_DspEnableInterrupt.c
 *
 *  @path   $(DSPLINK)\gpp\src\test\dsp
 *
 *  @desc   Implemetation of DSP_EnableInterrupt API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#include <API_DspEnableInterrupt.h>
...
API_DspEnableInterrupt (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 4) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_DspEnableInterrupt. "
                      "Status = [0x%x]", status) ;
    }
    ...
    if (DSP_SUCCEEDED (status)) {
        status = DSP_EnableInterrupt (processorId,
                                      &dspObj,
                                      intNum) ;
    }
