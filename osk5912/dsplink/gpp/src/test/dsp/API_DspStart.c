 ...
 *
 *  @desc   Implemetation of DSP_Start API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
 ...
 *  @func   API_DspStart
 *
 *  @desc   This test case tests the DSP_Start  API.
 *
 *  @modif  None.
 *  ============================================================================
 */
...
API_DspStart (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 4) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_DspStart. Status = [0x%x]",
                      status) ;
    }
    ...
    if (DSP_SUCCEEDED (status)) {
        ...
        startAddr = TST_StringToInt (argv [3]) ;
    ...
    if (DSP_SUCCEEDED (status)) {
        status = DSP_Start (processorId, &dspObj, startAddr) ;
    }
