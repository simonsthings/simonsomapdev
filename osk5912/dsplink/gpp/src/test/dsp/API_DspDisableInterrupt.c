/** ============================================================================
 *  @file   API_DspDisableInterrupt.c
 *
 *  @path   $(DSPLINK)\gpp\src\test\dsp
 *
 *  @desc   Implemetation of DSP_DisableInterrupt API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#include <API_DspDisableInterrupt.h>
...
API_DspDisableInterrupt (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 4) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_DspDisableInterrupt. "
                      "Status = [0x%x]", status) ;
    }
    ...
    if (DSP_SUCCEEDED (status)) {
        status = DSP_DisableInterrupt (processorId,
                                      &dspObj,
                                      intNum) ;
    }
