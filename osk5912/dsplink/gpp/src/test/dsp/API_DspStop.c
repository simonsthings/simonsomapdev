 ...
 *
 *  @desc   Implemetation of DSP_Stop API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
 ...
 *  @func   API_DspStop
 *
 *  @desc   This test case tests the DSP_Stop  API.
 *
 *  @modif  None.
 *  ============================================================================
 */
EXPORT_API
DSP_STATUS
API_DspStop (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 3) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_DspStop. Status = [0x%x]",
                      status) ;
    }
    ...
    if (DSP_SUCCEEDED (status)) {
        status = DSP_Stop (processorId, &dspObj) ;
    }
