/** ============================================================================
 *  @file   API_DspInitialize.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\dsp
 *
 *  @desc   Defines the interface of DSP_Initialize API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (API_DSPINITIALIZE_H)
#define API_DSPINITIALIZE_H
 ...
 *
 *  @desc   Tests the DSP_Initialize API.
 *
 *  @arg    argc
...
#endif /* !defined (API_DSPINITIALIZE_H) */
