 ...
 *
 *  @desc   Defines the interface of DSP_Read API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (API_DSPREAD_H)
#define API_DSPREAD_H
