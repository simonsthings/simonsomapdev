 ...
 *
 *  @desc   Implemetation of DSP_Idle API test case.
 *
 *  @ver    01.10.01
 *  ============================================================================
 ...
 *  @func   API_DspIdle
 *
 *  @desc   This test case tests the DSP_Idle  API.
 *
 *  @modif  None.
 *  ============================================================================
 */
EXPORT_API
DSP_STATUS
API_DspIdle (IN Uint32 argc, IN Char8 ** argv)
{
    ...
    if ((argc != 3) || (argv == NULL)) {
        ...
        TST_PrnError ("Incorrect usage of API_DspIdle. Status = [0x%x]",
                      status) ;
    }
    ...
    if (DSP_SUCCEEDED (status)) {
        status = DSP_Idle (processorId, &dspObj) ;
    }
