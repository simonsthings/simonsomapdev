/** ============================================================================
 *  @file   BVR_DataWrite.h
 *
 *  @path   $(DSPLINK)\gpp\src\test\behavior
 *
 *  @desc   Interface definition of behavior test for writing data to DSP.
 *
 *  @ver    01.10.01
 *  ============================================================================
...
#if !defined (BVR_DATAWRITE_H)
#define BVR_DATAWRITE_H
